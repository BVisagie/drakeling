...
from openclaw_hatchling.domain.decay import apply_care_boost
from openclaw_hatchling.domain.models import LifecycleStage, MoodState, PersonalityProfile
from openclaw_hatchling.llm.prompts import build_care_prompt
...
async def care(
    ...
    if llm and not llm.budget_exhausted:
        from openclaw_hatchling.domain.models import Creature, DragonColour
